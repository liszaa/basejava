...
public class ResumeTestData {
    ...
    public static void main(String[] args) {
        ...
        Organization organization1 = new Organization("http://javaops.ru/", "Java Online Projects", new Organization.PeriodInfo("Автор проекта",
                "Создание, организация и проведение Java онлайн проектов и стажировок.",
                LocalDate.of(2013, 10, 1), LocalDate.now()));

        Organization organization2 = new Organization("https://www.wrike.com/", "Wrike", new Organization.PeriodInfo("Старший разработчик (backend)",
        ...
        Organization organization3 = new Organization(null, "RIT Center", new Organization.PeriodInfo("Java архитектор",
        ...
        Organization organization4 = new Organization("https://www.luxoft.ru/", "Luxoft (Deutsche Bank)", new Organization.PeriodInfo("Ведущий программист",
        ...
        Organization organization5 = new Organization("https://www.yota.ru/", "Yota", new Organization.PeriodInfo("Ведущий специалист",
        ...
        Organization organization6 = new Organization("http://enkata.com/", "Enkata", new Organization.PeriodInfo("Разработчик ПО",
        ...
        Organization organization7 = new Organization("https://www.siemens.com/ru/ru/home.html", "Siemens AG", new Organization.PeriodInfo("Разработчик ПО",
        ...
        Organization organization8 = new Organization("http://www.alcatel.ru/", "Alcatel", new Organization.PeriodInfo("Инженер по аппаратному и программному тестированию",
                "Тестирование, отладка, внедрение ПО цифровой телефонной станции Alcatel 1000 S12 (CHILL, ASM).",
                LocalDate.of(1997, 9, 1), LocalDate.of(2005, 1, 1)));

        PeriodSection experiences = new PeriodSection(organization1, organization2, organization3, organization4, organization5, organization6, organization7, organization8);
        sections.put(SectionType.EXPERIENCE, experiences);


        // Section EDUCATION("Образование")
        Organization organ1 = new Organization("https://www.coursera.org/course/progfun", "Coursera", new Organization.PeriodInfo("\"Functional Programming Principles in Scala\" by Martin Odersky",
                "", LocalDate.of(2013, 1, 1), LocalDate.of(2013, 5, 1)));

        Organization organ2 = new Organization("http://www.luxoft-training.ru/training/catalog/course.html?ID=22366", "Luxoft", new Organization.PeriodInfo("Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"",
                "", LocalDate.of(2011, 3, 1), LocalDate.of(2011, 4, 1)));

        Organization organ3 = new Organization("http://www.siemens.ru/", "Siemens AG", new Organization.PeriodInfo("3 месяца обучения мобильным IN сетям (Берлин)",
                "", LocalDate.of(2005, 1, 1), LocalDate.of(2005, 4, 1)));

        Organization organ4 = new Organization("http://www.alcatel.ru/", "Alcatel", new Organization.PeriodInfo("6 месяцев обучения цифровым телефонным сетям (Москва)",
                "", LocalDate.of(1997, 9, 1), LocalDate.of(1998, 3, 1)));

        Organization organ5 = new Organization("http://www.ifmo.ru/", "Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики", new Organization.PeriodInfo("Аспирантура (программист С, С++)",
                "", LocalDate.of(1993, 9, 1), LocalDate.of(1996, 7, 1)), new Organization.PeriodInfo("Инженер (программист Fortran, C)", "", LocalDate.of(1987, 9, 1), LocalDate.of(1993, 7, 1)));

        Organization organ6 = new Organization("http://www.school.mipt.ru/", "Заочная физико-техническая школа при МФТИ", new Organization.PeriodInfo("Закончил с отличием",
                "", LocalDate.of(1984, 9, 1), LocalDate.of(1987, 6, 1)));

        PeriodSection educations = new PeriodSection(organ1, organ2, organ3, organ4, organ5, organ6);
    ...
    public Resume resumeInit(String fullName, String uuid) {
        ...
        // Section ACHIEVEMENT("Достижения")
        BulletedListSection achievement = new BulletedListSection("Достижение1 " + fullName + " : " + uuid, "Достижение2 " + fullName + " : " + uuid, "Достижение3 " + fullName + " : " + uuid);
        sections.put(SectionType.ACHIEVEMENT, achievement);

        // Section QUALIFICATIONS("Квалификация")
        BulletedListSection qualification = new BulletedListSection("Квалификация1 " + fullName + " : " + uuid, "Квалификация2 " + fullName + " : " + uuid, "Квалификация3 " + fullName + " : " + uuid);
        sections.put(SectionType.QUALIFICATIONS, qualification);

        // Section EXPERIENCE("Опыт работы")
        Organization organization1 = new Organization(" ", "Организация1", new Organization.PeriodInfo("Должность в организации1 " + fullName + " : " + uuid,
                "Описание организации1",
                LocalDate.of(2013, 10, 1), LocalDate.now()));

        Organization organization2 = new Organization(" ", "Организация2", new Organization.PeriodInfo("Должность в организации2 " + fullName + " : " + uuid,
                "Описание организации2",
                LocalDate.of(2014, 10, 01), LocalDate.of(2016, 1, 1)));

        Organization organization3 = new Organization(" ", "Организация3", new Organization.PeriodInfo("Должность в организации3 " + fullName + " : " + uuid,
                "Описание организации2",
                LocalDate.of(2012, 1, 1), LocalDate.of(2014, 10, 1)));

        PeriodSection experiences = new PeriodSection(organization1, organization2, organization3);
        sections.put(SectionType.EXPERIENCE, experiences);

        // Section EDUCATION("Образование")
        Organization organ1 = new Organization(" ", "Обучение1", new Organization.PeriodInfo("Описание обучения1 " + fullName + " : " + uuid,
                null,
                LocalDate.of(2013, 10, 1), LocalDate.now()));

        Organization organ2 = new Organization(" ", "Обучение2", new Organization.PeriodInfo("Описание обучения22 " + fullName + " : " + uuid,
                null,
                LocalDate.of(2014, 10, 01), LocalDate.of(2016, 1, 1)));

        Organization organ3 = new Organization(" ", "Обучение3", new Organization.PeriodInfo("Описание обучения3 " + fullName + " : " + uuid,
                null,
                LocalDate.of(2012, 1, 1), LocalDate.of(2014, 10, 1)));

        PeriodSection educations = new PeriodSection(organ1, organ2, organ3);
        sections.put(SectionType.EDUCATION, educations);
